...
public class SensitivitySlider : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        sensitivitySlider.value = GameSettings.Instance.sensitivityStep;
    ...
    private void UpdateSliderValue(float value)
    {
        ...
        // 설정 저장
        GameSettings.Instance.sensitivityStep = Mathf.RoundToInt(value);
    ...
    {
        int step = GameSettings.Instance.sensitivityStep;
        float sensitivity;
